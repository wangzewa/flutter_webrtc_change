    ...
    switch (call.method) {
      ...
      case "mediaStreamAddTrack": {
        ...
        for (int i = 0; i < renders.size(); i++) {
          ...
          if (renderer!=null&&renderer.checkMediaStream(streamId)!=null&&renderer.checkMediaStream(streamId)) {
      ...
      case "videoRendererDispose": {
        ...
        FlutterRTCVideoRenderer render = renders.get(Long.valueOf(textureId+"").longValue());
